...
bool step(void)
{
    ...
    return moons[0].v.y == 0 && moons[0].p.y ==  moons[0].p0.y &&
           moons[1].v.y == 0 && moons[1].p.y ==  moons[1].p0.y &&
           moons[2].v.y == 0 && moons[2].p.y ==  moons[2].p0.y &&
           moons[3].v.y == 0 && moons[3].p.y ==  moons[3].p0.y;
}
