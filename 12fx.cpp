...
bool step(void)
{
    ...
    return moons[0].v.x == 0 && moons[0].p.x ==  moons[0].p0.x &&
           moons[1].v.x == 0 && moons[1].p.x ==  moons[1].p0.x &&
           moons[2].v.x == 0 && moons[2].p.x ==  moons[2].p0.x &&
           moons[3].v.x == 0 && moons[3].p.x ==  moons[3].p0.x;
}
