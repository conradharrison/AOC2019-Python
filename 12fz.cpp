...
bool step(void)
{
    ...
    return moons[0].v.z == 0 && moons[0].p.z ==  moons[0].p0.z &&
           moons[1].v.z == 0 && moons[1].p.z ==  moons[1].p0.z &&
           moons[2].v.z == 0 && moons[2].p.z ==  moons[2].p0.z &&
           moons[3].v.z == 0 && moons[3].p.z ==  moons[3].p0.z;
}
